...
\node[shape=rectangle, rounded corners, draw, align=center, top color=white, bottom color=black!20, text=black!50] (n9) at (4.0,2.0) {9};
\node[shape=rectangle, rounded corners, draw, align=center, top color=white, bottom color=black!20, text=black!50] (n10) at (1.0,3.0) {10};
...
\draw[thick,black!20,dashed,->] (n9) -- (n10);
\draw[thick,black!20,->] (n9) -- (n11);
\draw[thick,black!20,->] (n10) -- (n11);
\end{tikzpicture}
\end{document}

...
function print_lvector(v :: AbstractVector)
    m = length(v)
...
function print_cvector(v :: AbstractVector, c)
    m = length(v)
    println("\\begin{bmatrix}")
    for i = 1:m
        println("{\\color{$(c[i])}$(v[i])} \\\\")
    end
    println("\\end{bmatrix}")
end

function print_lmatrix(A :: AbstractMatrix)
    m, n = size(A)
    println("\\begin{bmatrix}")
    for i = 1:m
        print("$(A[i,1])")
...
function print_cmatrix(A :: AbstractMatrix, c)
    m, n = size(A)
    println("\\begin{bmatrix}")
    for i = 1:m
        print("{\\color{$(c[i,1])}$(A[i,1])}")
        for j = 2:n
            print(" & {\\color{$(c[i,j])}$(A[i,j])}")
        end
        println(" \\\\")
    end
    println("\\end{bmatrix}")
...
let
    ...
    print_lmatrix(A)
    println(" = ")
    print_cmatrix(gray_zero_cmatrix(U)...)
    println("\$\$\n")
    println(". . .\n")
